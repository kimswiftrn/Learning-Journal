...
read05 11.20.19
Learning Journal
CSS makes webpages more attractive and engaging to the reader.
One goal of using CSS is to create a page that the reader will want to spend time viewing. 
